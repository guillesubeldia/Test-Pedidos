      ...
      <div class="col-md-10">
        ...
        <div class="box box-primary">
          ...
          <div class="box-body">
            ...
            <form role="form" action="<?php echo base_url()."index.php/Proveedores/C_Proveedores/CargarProveedor";?>" method="post">
              <div class="row">
                <div class="col-md-12">
                  <div class="form-group">
                    <label >Nombre Proveedor (*)</label>
                    <input type="text" name="nombreProveedor" value="<?php echo set_value('nombreProveedor');?>" class="form-control" required>
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      <div class="form-group">
                        <label>CUIT</label>
                        <input type="text" name="cuitProveedor" value="<?php echo set_value('cuitProveedor');?>" class="form-control" required>
                  ...
                  <div class="table-scrollable">
                    <table id="tablaContacto" class="table table-striped table-bordered table-advance table-hover">
                      ...
                      <tbody>
                        <tr id="1">
                          <td>
                            <select class="form-control" name="tipoContactoProveedor[1]" tabindex="1" required>
                            <?php
                          ...
                          <td> <input required type="text"  name='contactoProveedor[1]' class="form-control"> </td>
                          <td> <input required type="text"  name='observacionContactoProveedor[1]' class="form-control"> </td>
               ...
               <div class="col-md-12">
                 ...
                 <div class="row">
                   <div class="col-md-4">
                     <div class="form-group">
                       <label >Calle</label>
                       <input  type="text" name="calleProveedor" value="<?php echo set_value('calleProveedor');?>" class="form-control" required>
                   ...
                   <div class="col-md-2">
                     <div class="form-group">
                       <label >Manzana</label>
                       <input  type="text" name="manzanaProveedor" class="form-control" required>
                     </div>
                   </div>
                   ...
                   <div class="col-md-2">
                     <div class="form-group">
                       ...
                       <input  type="text" name="numeroProveedor" value="<?php echo set_value('numeroProveedor');?>" class="form-control" required>
                   ...
                   <div class="col-md-2">
                     <div class="form-group">
                       <label >Piso</label>
                       <input  type="text" name="pisoProveedor" class="form-control" required>
                     </div>
                   </div>
                   <div class="col-md-2">
                     <div class="form-group">
                       <label >Departamento</label>
                       <input  type="text" name="departamentoProveedor" class="form-control" required>
                     </div>
                   </div>
                 </div>
                 ...
                 <div class="row">
                   <div class="col-md-12">
                     <div class="form-group">
                       ...
                       <textarea name="observacionProveedor" rows="3" cols="80" class="form-control" required></textarea>
                     </div>
                   </div>
                 </div>
               </div>
