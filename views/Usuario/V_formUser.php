            ...
            <div class="col-md-12">
                <div class="portlet box purple-plum">
                    ...
                    <div class="portlet-body form">
                        <form method="POST" action="<?php echo base_url() . 'Usuarios/C_Usuarios/CrearUsuario'; ?>" class="form-horizontal">
                            <div class="form-body">
                                            ...
                                            <div class="tab-pane active" id="tab_6_1">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="input-icon right">
                                                            <i class="fa"></i>
                                                            <input type="email" class="form-control" name="emailEmpleado" required>
                                                        </div>
                                                        <span class="help-block"><font color="red"><?php echo form_error('emailEmpleado');?></font></span>
                                                    </div>
                                                </div>

                                                <input type="hidden" value="<?php echo $documentoEmpleado;?>" name="documentoEmpleado">

                                                <!-- Este se usa para editar
                                                <div class="form-group">
                                                    <label class="control-label col-md-3">Contraseña <span class="required"> * </span></label>
                                                    <div class="col-md-6">
                                                        <div class="input-icon right">
                                                            <i class="fa"></i>
                                                            <input type="password" class="form-control" name="claveUsuario" required>
                                                        </div>
                                                          <span class="help-block"><font color="red"><?php// echo form_error('claveUsuario');?></font></span>
                                                    </div>
                                                </div>

                                                <div class="form-group">
                                                    <label class="control-label col-md-3">Repetir Contraseña<span class="required"> * </span></label>
                                                    <div class="col-md-6">
                                                        <div class="input-icon right">
                                                            <i class="fa"></i>
                                                            <input type="password" class="form-control" name="repetirClaveUsuario" required>
                                                        </div>
                                                          <span class="help-block"><font color="red"><?php// echo form_error('repetirClaveUsuario');?></font></span>
                                                    </div>
                                                </div>
                                              -->
                                                <div class="form-group">
