...
<head>
  ...
  <!-- daterange picker -->
  <link rel="stylesheet" href="<?php echo base_url(). 'plantilla/bower_components/bootstrap-daterangepicker/daterangepicker.css'?>">
  <!-- bootstrap datepicker -->
  <link rel="stylesheet" href="<?php echo base_url(). 'plantilla/bower_components/bootstrap-datepicker/dist/css/bootstrap-datepicker.min.css'?>">
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="../../index2.html" class="logo">
      ...
      <span class="logo-lg"><b>MDH</b> Seguimiento</span>
    </a>
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="<?php echo base_url(). 'plantilla/dist/img/user2-160x160.jpg'?>"  class="user-image" alt="User Image">
              <span class="hidden-xs"><?php echo $this->session->userdata('nombreUsuario')?></span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
              <li class="user-header">
                <img src="<?php echo base_url(). 'plantilla/dist/img/user2-160x160.jpg'?>" class="img-circle" alt="User Image">

                <p>
                  <?php echo $this->session->userdata('nombreUsuario')?> - <?php echo $this->session->userdata('perfilUsuario')?>
              ...
              <li class="user-footer">
                <div class="pull-left">
                  <a href="<?php echo base_url().'/Usuario/C_Usuario/';?>" class="btn btn-default btn-flat">Perfil</a>
                </div>
