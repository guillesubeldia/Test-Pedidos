              ...
              <div class="row">
                <div class="col-md-12">
                  <div class="row">
                    ...
                    <div class="col-md-8">
                      <div class="form-group">
                        ...
                        <input type="text" name="txtNroDocumento" minlength="7" maxlength="9" required class="form-control" value="<?php echo $tutor->numero_documento ?>">
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="txtNombre" class="form-control" value="<?php echo $tutor->nombre ?>" required>
                  </div>

                  <div class="form-group">
                    <label for="">Apellido (*)</label>
                    <input type="text" name="txtApellido" class="form-control" value="<?php echo $tutor->apellido ?>" required>
                  </div>

                  <div class="form-group">
                    <label for="txtProfesion">Profesión (*)</label>
                    <input type="text" name="txtProfesion" class="form-control" value="<?php echo $tutor->profesion ?>" required>
                  </div>
                </div>
              </div>
                      ...
                      <tbody>
                        ...
                        ?>
                          <tr>
                            ...
                            <td> <input type="text" name="txtContacto[<?php echo $row_index ?>]" class="form-control" value="<?php echo $row->descripcion ?>"> </td>
                 ...
                 <div class="row">
                   <div class="col-md-4">
                     <div class="form-group">
                       ...
                       <input type="text" name="txtCalle" class="form-control" value="<?php echo $domicilio->calle ?>">
                     </div>
                   </div>
                   ...
                   <div class="col-md-2">
                     <div class="form-group">
                       ...
                       <input type="text" name="txtManzana" class="form-control" value="<?php echo $domicilio->manzana ?>">
                     </div>
                   </div>
                   ...
                   <div class="col-md-2">
                     <div class="form-group">
                       ...
                       <input type="text" name="txtNumero" class="form-control" value="<?php echo $domicilio->numero ?>">
                     </div>
                   </div>
                   ...
                   <div class="col-md-2">
                     <div class="form-group">
                       ...
                       <input type="text" name="txtDepartamento" class="form-control" value="<?php echo $domicilio->departamento ?>">
                     </div>
                   </div>
                 </div>
